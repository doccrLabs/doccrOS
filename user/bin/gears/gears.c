 ...
 * PROJECT: sulfurOS
 * FILE: gears.c
 * CREDITS: Offihito (for whole gears + tinygl port)
 *
 */
...
int main() {
  ...
  while (1) {
    ...
    ui16_setRoot(pixel_buffer, w, h);

    // 3. Construct ui16 UI tree (e.g., optional overlay/labels)
    ui16_container(style(width(fill), height(fill), padding(8))) {
